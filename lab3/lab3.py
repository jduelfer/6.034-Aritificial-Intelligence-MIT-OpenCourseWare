...
def focused_evaluate(board):
    """
    Instead of multiplying the longest chain by ten, we multiply the
    longest chain by how many turns are left. Therfore, in the beginning
    of the game, chains are more valuable then the end of the game.
    """    
    if board.is_game_over():
        ...
        early_win_multiplier = abs(board.num_tokens_on_board() - (7 * 6))
        score = board.longest_chain(board.get_current_player_id()) * early_win_multiplier
